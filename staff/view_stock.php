...
if (!in_array('name', $columns)) {
    $productNameCol = in_array('product_name', $columns) ? 'product_name' : (in_array('title', $columns) ? 'title' : 'productname');
}
    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-4 py-3 shadow-lg" style="background: linear-gradient(135deg, #3EB489, #22C55E);">
        <div class="container-fluid">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a href="request_item.php" class="nav-link"><i class="fas fa-plus-circle me-1"></i>Request Stock</a>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <a href="request_item.php" class="btn btn-primary-mint btn-lg shadow-lg">
                        ...
                        <tbody>
                            <?php if ($result->num_rows > 0): ?>
                                <?php while ($product = $result->fetch_assoc()): ?>
                                    <tr class="<?= ($product['quantity'] ?? 0) < 10 ? 'table-danger' : (($product['quantity'] ?? 0) < 20 ? 'table-warning' : 'table-success') ?>">

                                        <!-- SAFE IMAGE -->
                                        <td>
                                            <?php $imageFile = trim($product['image'] ?? ''); ?>

                                            <?php if (!empty($imageFile) && file_exists(__DIR__ . '/../images/' . $imageFile)): ?>
