                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <select name="image_name" class="form-select">
                            ...
                            <option value="chicken breast.png">Chicken Breast</option>
                            <option value="rice.png">Basmati Rice</option>
                            <option value="aata.png">Wheat Flour</option>
                            <option value="oil.png">Cooking Oil</option>
                            <option value="masoor dal.png">Masoor Dal</option>
                            <option value="toor dal.png">Toor Dal</option>
                            <option value="milk.png">Milk</option>
                            <option value="okra.png">Okra</option>
                            <option value="onion.png">Onions</option>
                            <option value="potato.png">Potatoes</option>
                            <option value="tomato.png">Tomatoes</option>
                            <option value="watermelon.png">Watermelon</option>
                        </select>
                    </div>
                </div>
            </div>
